...
const GET_TASKS_API_BASE_URL = "http://get-tasks-api.my-app-gateway.shop";
const DELETE_TASK_API_BASE_URL = "http://delete-task-api.my-app-gateway.shop";
const CREATE_TASK_API_BASE_URL = "http://add-task-api.my-app-gateway.shop";
